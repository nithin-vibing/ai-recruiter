      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0A0A0F] items-center justify-center p-12">
        <div className="max-w-md space-y-8">
          ...
          <div className="grid grid-cols-3 gap-4 pt-4">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-center">
              <p className="text-2xl font-bold text-electric-blue">Free</p>
              <p className="text-xs text-white/50 mt-1">To get started</p>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 space-y-3">
            <div className="flex gap-0.5">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="h-4 w-4 text-electric-blue" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
              ))}
            </div>
            <p className="text-sm text-white/70 leading-relaxed italic">
              &ldquo;We went from 3 hours of resume screening to under 20 minutes. The per-criterion breakdown is what sold me — I can see exactly why each candidate scored the way they did.&rdquo;
            </p>
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-full bg-electric-blue/20 flex items-center justify-center shrink-0">
                <span className="text-xs font-bold text-electric-blue">S</span>
              </div>
              <div>
                <p className="text-xs font-medium text-white/80">Sarah K.</p>
                <p className="text-xs text-white/40">Head of Talent, Series A startup</p>
              </div>
            </div>
          </div>
        </div>
